...
The following benchmark prompts validate retrieval quality, tool routing,
hallucination prevention, escalation handling, and grounded response generation.
...
| Query Group | Tool Triggered | Expected Behavior |
|---|---|---|
| Q1–Q5 | SearchKB | Grounded retrieval with citations |
| Q6–Q9 | ComputeSuccessRate | Reliability statistics |
| Q10–Q12 | GetLaunchWindow | Launch windows + Δv analysis |
| Q13–Q15 | GetPolicy | Policy retrieval with metadata |
| Q16–Q18 | CreateTicket | Escalation workflow + Ticket ID |
| Q19–Q20 | Out-of-Scope Guard | Safe rejection with no tool call |
...
**Expected:**  
KB gap detection + external search recommendation + optional escalation workflow# Author
